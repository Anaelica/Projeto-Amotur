...
const points: Point[] = [
  ...
  },
  {
    ...
    },
    {
      ...
      image: '/pousada vila icarai.jpeg',
  ...
  export default function Map({ search, setSearch }: MapProps) {
    return (
